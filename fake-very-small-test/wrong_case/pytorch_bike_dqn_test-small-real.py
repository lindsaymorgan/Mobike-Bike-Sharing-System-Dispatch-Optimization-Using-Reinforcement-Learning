...
class Env(object):
    def __init__(self, region_num, move_amount_limit, eps_num):
        ...
        self.t = 0
        self.obs_init = np.array([1500, 1500, 1500, 1500, 0, 0,0,0,1500,1500, 1500, 1500, 0, 0])  # 各方格单车量+货车位置+货车上的单车量
        ...
        for i in range(1):
            ...
            while True:
                ...
                print(
                    ...
                    file=open(f"result_action/real_output_action_{ts}.txt", "a"))
                # if render:
                #     env.render()
                if done:
                    break
        ...
        while True:
            ...
            if net.memory_counter >= 5*BATCH_SIZE:
                ...
                if done:
                    ...
                    print(f"{round(reward_sum, 3)}", file=open(f"result_history/real_output_result_{ts}.txt", "a"))
