...
def save_frames_as_gif(frames, index): # 将gym环境的运行过程保存为gif
    ...
    anim.save('./mountain_car_'+str(index)+'.gif', writer='imagemagick', fps=30)
...
if __name__ == "__main__":
    ...
    for episode in range(1, 1001):
        ...
        frames = []
        tag = " No Goal"
        for _ in range(200):  # 在GitHub的文档中，与说明不符，没有超过200步done=True的设定？所以这里手动设置一下
            if episode % 1000 == 0:
        ...
        print('Episode:', episode, ', Total reward:', round(totalReward, 3), tag)
