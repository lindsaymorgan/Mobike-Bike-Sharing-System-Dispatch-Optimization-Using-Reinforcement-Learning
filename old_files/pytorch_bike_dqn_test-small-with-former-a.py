        ...
        for i in range(1):
            ...
            while True:
                ...
                print(
                    ...
                    f"move:{action % (2 * self.move_amount_limit + 1) - self.move_amount_limit}",
                    file=open("output_action_ver2.txt", "a"))
                # if render:
                #     env.render()
                if done:
                    break
        ...
        while True:
            ...
            if net.memory_counter >= MEMORY_CAPACITY:
                ...
                if done:
                    ...
                    print(f"{round(reward_sum, 3)}", file=open("output_result_ver2.txt", "a"))
